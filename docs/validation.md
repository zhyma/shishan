...
| 三系统 CI 定义 | Linux/macOS/Windows Node 24 matrix | 已实现，待远端运行 |
...
Vite production build: 175 modules transformed
Web JS gzip: 136.34 kB
Web CSS gzip: 5.48 kB
```
...
- GitHub-hosted Windows 和 macOS runner 的 native grammar 实际安装结果；
